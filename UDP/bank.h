...
typedef struct Client_t {
    ...
    SOCKADDR_IN addr;   //adresse du socket client
     
}Client;

static int read_socket(SOCKET _socket, SOCKADDR_IN *addr, char *buffer);
static void write_socket(SOCKET _socket, SOCKADDR_IN *addr, char *buffer);
